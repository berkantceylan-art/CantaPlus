    ...
    <div className="space-y-6 max-w-4xl animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm font-medium text-muted-foreground uppercase tracking-widest">Kataloğa yeni bir parça ekleyin</p>
        </div>
      </div>
        ...
        <div className="space-y-6">
          ...
          <Card className="border-zinc-200 dark:border-zinc-800 rounded-3xl overflow-hidden shadow-sm bg-zinc-900 text-white">
            <CardContent className="p-8 space-y-6">
              ...
              <Button type="submit" className="w-full h-12 rounded-xl font-bold uppercase tracking-widest text-xs" disabled={isPending}>
                {isPending ? (
                  <>
